...
void * th_piece(void * param_data)
{
  ...
  printf("thPiece%lX : j'envoie le message depose la piece brute sur le convoyeur\n",(long)pthread_self());
  ...
  printf("thPiece%lX : j'attends de recevoir la confirmation du robot alimentation\n",(long)pthread_self());
  ...
  printf("thPiece%lX :j'ai recu la confirmation du robot alimentation\n",(long)pthread_self());
  ...
  {
    printf("thPiece%lX : arret du system de supervision : le robot d'alimentation ne répond pas ou n'a pas pu retirer la piece au bout de 20 secondes\n",(long)pthread_self());
    pthread_kill(SIGUSR1,thIdDialog);
  }
  /*Sinon le thread reçois fin de depot sur convoyeur*/
  
  sprintf(message,"deposer brute table");
  printf("thPiece%lX : j'envoie le message depose la piece brute sur la table\n",(long)pthread_self());
  ...
  messRec=malloc(attr.mq_msgsize);
  printf("thPiece%lX : j'attends de recevoir la confirmation de la machine%d\n",(long)pthread_self(),numero_machine);
  ...
  printf("thPiece%lX : j'ai recu la confirmation de la machine%d\n",(long)pthread_self(),numero_machine);
  if(messRec == NULL)
  {
    printf("thPiece%lX : la machine numero %d n'a pas fini de retirer la pièce du convoyeur après 50 secondes\n",(long)pthread_self(), numero_machine);
  ...
  messRec=malloc(attr.mq_msgsize);
  printf("thPiece%lX : j'attends que la machine%d finisse de travailler\n",(long)pthread_self(),numero_machine);
  ...
  printf("thPiece%lX : j'ai recu la confirmation de fin d'usinage par la machine%d\n",(long)pthread_self(),numero_machine);
   if(messRec == NULL)
  {
  ...
  printf("thPiece%lX : j'envoie le message depose la piece usinee sur le convoyeur\n",(long)pthread_self());
  if(mq_send(messageQueueMachine[numero_machine],message,sizeMessage,0)!=0)
  {
    erreur("envoie du message a la file de message table  ",95);
  }
  messRec=malloc(attr.mq_msgsize);
  printf("thPiece%lX : j'attends de recevoir la confirmation de depot de la machine%d\n",(long)pthread_self(),numero_machine);
  ...
  printf("thPiece%lX : j'ai recu la confirmation de depot de la machine%d\n",(long)pthread_self(),numero_machine);
  if(messRec == NULL)
  {
    printf("thPiece%lX : la machine numero %d n'a pas depose la pièce usine sur le convoyeur après 30 secondes\n",(long)pthread_self(), numero_machine);
    pthread_kill(SIGUSR1,thIdDialog);
  }
  /*sinon le thread recois fin de depot piece piece usine sur convoyeur*/
  sprintf(message,"retirer usine conv");
  printf("thPiece%lX : j'envoie le message retirer la piece usinee sur le convoyeur\n",(long)pthread_self());
  if(mq_send(messageQueueRobotRe,message,sizeMessage,0)!=0)
  {
    erreur("envoie du message a la file de message robot retrait  ",95);
  }
  messRec=malloc(attr.mq_msgsize);
  printf("thPiece%lX : j'attends de recevoir la confirmation du robot de retrait\n",(long)pthread_self());
  timer.tv_sec += 30;/* timer se declanchera dans 30 secondes */
  ...
  printf("thPiece%lX : j'ai recu la confirmation du robot retrait\n",(long)pthread_self());
  if(messRec == NULL)
  {
    printf("thPiece%lX : arret du system de supervision : le robot d'alimentation ne répond pas ou n'a pas pu retirer la piece au bout de 20 secondes\n",(long)pthread_self());
    pthread_kill(SIGUSR1,thIdDialog);
  ...
  pthread_kill(SIGUSR2,thIdDialog);
  printf("thPiece %lX: Usinage de la piece %d : OK \n",(long)pthread_self(),code_piece);
  pthread_exit(0);
}
